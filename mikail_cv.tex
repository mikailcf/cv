...
\ifport
    ...
    {\mypositionface Programador Solo} \\
    Jogo 2D de plataforma com {\it engine} próprio para física e efeitos de luz e sombra. Projeto multiplataforma usando OpenGL, GLSL e a biblioteca SFML (C++) para gráficos e {\it input}. Atualmente possui versão em início de desenvolvimento para Mac OS X.

    {\myprojectface Jogo iOS em Swift} \hfill 2015 — presente (esparso) \\
    {\mypositionface Programador Solo} \\
    Jogo 2D de plataforma {\it corrida infinita} que utiliza o {\it framework} SpriteKit da Apple para gráficos e física, com {\it engine} próprio para geração de conteúdo procedural como obstáculos, imagem de fundo e etc.
\else
...
\else
    ...
    - Fluent english, basic japanese, basic spanish
\fi
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
\ifport
