...
\ifport
    ...
    {\mypositionface Programador Solo} \\
    Jogo 2D de plataforma com {\it engine} próprio para física e efeitos de luz e sombra. Projeto multiplataforma usando OpenGL, GLSL e a biblioteca SFML (C++) para gráficos e {\it input}. Atualmente possui versão em fase de desenvolvimento para Mac OS X.
...
\else
    ...
    Currently has a version in development stage for Mac OS X.
