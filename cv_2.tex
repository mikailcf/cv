...
{\mypositionface Programador Solo} \\
Jogo 2D com {\it engine} própria para física e efeitos de luz e sombra. Projeto multiplataforma usando a biblioteca multimídia SFML (C++), OpenGL e GLSL. Atualmente possui versão para Mac OS X e Windows.
